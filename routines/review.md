...
## Steps
1. Monday to Sunday, no rolling window. "how was my week"/"review": this week, "last week" the previous one. Eligible dates: this week Monday to today, last week all seven; future dates never missing.
...
3. Average per day = seven totals ÷ days counted, rounded by `routines/log.md` step 4.
4. Days on target: verdicts reading `on target`. Most common miss: top `<macro> low|high`, day count; ties name each.
