...
The first command checks the vault against the node schemas in `docs/spec/` and the Router, Index, State and routine rules. The second runs the lint's own tests.
